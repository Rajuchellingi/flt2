...
class CollectionV1Controller extends GetxController with BaseController {
  ...
  var collectionFilterValues = new ProductCollectionV1VM(
    collection: null,
    count: null,
    catalogUrl: null,
    multiBooking: null,
  ...
  filterSortItem(item) {
    ...
    var sortItem = new SelectedFilter(fieldName: 'sortBy', fieldValue: item);
