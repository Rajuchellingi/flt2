...
class LandingPageController extends GetxController
  ...
  getTemplate() async {
    ...
    template.value = allTemplates.firstWhere(
        (value) => value['id'] == landingPageId.value,
        orElse: () => {});
  ...
  navigateByUrlType(link) async {
    if (link != null && link['value'] != null) {
      if (link['kind'] == 'collection') {
        ...
        var result = await Get.toNamed('/landingPage',
            arguments: {'id': landingPageId}, preventDuplicates: false);
        // categoryList.refresh();
