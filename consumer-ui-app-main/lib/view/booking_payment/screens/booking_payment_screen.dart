...
import 'package:black_locust/view/booking_payment/components/booking_payment_body.dart';
import 'package:black_locust/view/booking_payment/components/booking_place_order_button.dart';
import 'package:black_locust/view/header/common_header.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class BookingPaymentScreen extends StatelessWidget {
  final _controller = Get.find<BookingPaymentController>();
      ...
      return SafeArea(
          child: Scaffold(
              ...
              body: _controller.isLoading.value
                  ...
                  : Container(
                      child: BookingPaymentBody(controller: _controller),
                    ),
              bottomNavigationBar: _controller.bookingDetail.value.sId != null
                  ? BookingPlaceOrderButton(controller: _controller)
