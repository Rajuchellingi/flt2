...
class CheckoutV1ProductDetails extends StatelessWidget {
  const CheckoutV1ProductDetails({
    Key? key,
                          ...
                          if (element.type == "pack" &&
                            ...
                            if (element.setIsCustomizable == false) ...[
                              Container(
                                  ...
                                  child: Text(
                                    "1 Set = ${element.setQuantityValue} Pieces; ${getSetQuantity(element.variants)}",
                                    style: const TextStyle(
                                        fontSize: 13, color: Colors.black54),
                                  ))
                              ...
                              Container(
                                  child: Text(
                                "1 Set = ${element.setQuantityValue} Pieces; Assorted ${element.preferenceVariant!.attributeLabelName};",
                                style: const TextStyle(
                                    fontSize: 13, color: Colors.black54),
                              )),
                            ]
