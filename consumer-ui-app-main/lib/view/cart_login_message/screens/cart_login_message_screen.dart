...
import 'package:black_locust/view/cart_login_message/components/cart_login_message_blocks.dart';
...
class CartLoginMessageScreen extends StatelessWidget {
  final _controller = Get.find<CartLoginMessageController>();
            ...
            children: [
              Container(
                child: _controller.isLoading.value
                    ...
                    : CartLoginMessageBlocks(controller: _controller),
              ),
            ],
          ),
