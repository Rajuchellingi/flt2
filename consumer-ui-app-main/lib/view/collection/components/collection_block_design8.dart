...
import 'package:black_locust/common_component/product_image_slider.dart';
...
class CollectionBlockDesign8 extends StatelessWidget {
  CollectionBlockDesign8({Key? key, required controller, required this.design})
...
class ItemCard extends StatelessWidget {
      ...
      return GestureDetector(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            if (!isSmallView) ...[
              const SizedBox(height: 5),
              _buildProductDetails(showVariants),
            ],
          ],
        ),
      );
  ...
  Widget _buildProductDetails(bool showVariants) {
    return Padding(
      ...
      children: [
        ...
        if (product.price?.mrp != 0 &&
          ...
          Container(
            ...
            child: Text(
              "${CommonHelper.currencySymbol()} ${product.price?.mrp ?? 0}",
              style: TextStyle(
                decoration: TextDecoration.lineThrough,
                color:
                    brightness == Brightness.dark ? Colors.grey : Colors.black,
