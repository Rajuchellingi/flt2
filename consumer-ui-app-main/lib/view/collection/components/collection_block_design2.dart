...
class CollectionBlockDesign2 extends StatelessWidget {
  CollectionBlockDesign2({Key? key, required controller, required this.design})
    ...
    if (product.price?.mrp != 0 &&
      ...
      var discountAmount =
          ((product.price!.mrp! - product.price!.sellingPrice!) /
                  product.price!.mrp!) *
              100;
      discount = double.parse(discountAmount.toStringAsFixed(2));
    }
