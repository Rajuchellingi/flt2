...
import 'package:black_locust/view/collection/components/collection_block_design1.dart';
import 'package:black_locust/view/collection/components/collection_block_design2.dart';
import 'package:black_locust/view/collection/components/collection_block_design3.dart';
import 'package:black_locust/view/collection/components/collection_block_design4.dart';
import 'package:black_locust/view/collection/components/collection_block_design5.dart';
import 'package:black_locust/view/collection/components/collection_block_design6.dart';
import 'package:black_locust/view/collection/components/collection_block_design7.dart';
import 'package:black_locust/view/collection/components/collection_block_design8.dart';
...
class CollectionBlocks extends StatelessWidget {
  CollectionBlocks({Key? key, required this.controller}) : super(key: key);
  ...
  Widget _buildProductListComponent(Map<String, dynamic> item) {
    ...
    switch (item['instanceId']) {
      case 'design1':
        child = CollectionBlockDesign1(controller: controller, design: item);
        break;
      case 'design2':
        child = CollectionBlockDesign2(controller: controller, design: item);
        break;
      case 'design3':
        child = CollectionBlockDesign3(controller: controller, design: item);
        break;
      case 'design4':
        child = CollectionBlockDesign4(controller: controller, design: item);
        break;
      case 'design5':
        child = CollectionBlockDesign5(controller: controller, design: item);
        break;
      case 'design6':
        child = CollectionBlockDesign6(controller: controller, design: item);
        break;
      case 'design7':
        child = CollectionBlockDesign7(controller: controller, design: item);
        break;
      case 'design8':
        child = CollectionBlockDesign8(controller: controller, design: item);
        break;
      default:
        return const SizedBox.shrink();
    }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          if (sortItem != null &&
              sortItem["instanceId"] == "design4" &&
              controller.sortSetting.value.isNotEmpty)
            _buildButton(
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final banners = controller.collectionData.value.banners ?? [];
      final collectionName =
          controller.collectionData.value.collectionName ?? '';
        ...
        body: Column(
          children: [
            ...
            ...typedBlocks.map((item) {
              if (hasFilterDesign1 ||
                  hasSortDesign1 ||
                  (hasFilterDesign1 && hasSortDesign1) ||
