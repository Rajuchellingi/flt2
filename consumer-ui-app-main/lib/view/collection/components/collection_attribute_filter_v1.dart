...
class CollectionAttributeFilterV1 extends StatefulWidget {
  const CollectionAttributeFilterV1({
    Key? key,
  ...
  final dynamic filterAttribute; // Specify the correct type

  @override
  _AttributeFilterState createState() => _AttributeFilterState();
}

class _AttributeFilterState extends State<CollectionAttributeFilterV1> {
  ...
  bool checkIsSelected(fieldName, fieldValue) {
    if (_controller.selectedFilterAttr.value != null &&
      ...
      // _controller.updateFilter(fieldName,fieldValue);
      return isFieldName;
    } else {
      return false;
    }
