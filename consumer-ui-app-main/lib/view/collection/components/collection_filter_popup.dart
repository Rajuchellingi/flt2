...
import 'package:black_locust/view/collection/components/collection_attribute_filter_v1.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:black_locust/const/constant.dart';

class CollectionFilterPopup extends StatefulWidget {
  @override
  _FilterComponentState createState() => _FilterComponentState();
  final _cController;
  const CollectionFilterPopup({
    Key? key,
    required controller,
...
class _FilterComponentState extends State<CollectionFilterPopup> {
