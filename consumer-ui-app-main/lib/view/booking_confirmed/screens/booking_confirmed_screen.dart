...
import 'package:black_locust/view/booking_confirmed/components/booking_confirmed_body.dart';
...
class BookingConfirmedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final _controller = Get.find<BookingConfirmationController>();
    return Obx(() {
      ...
      return SafeArea(
        ...
        appBar: (header != null && header.isNotEmpty)
            ...
            : null,
        body: BookingConfirmedBody(controller: _controller),
      ));
    });
  }
}
