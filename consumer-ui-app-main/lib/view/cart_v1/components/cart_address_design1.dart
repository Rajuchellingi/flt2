...
class CartAddressDesign1 extends StatelessWidget {
  CartAddressDesign1({
    Key? key,
    required controller,
    ...
    return Obx(() {
      ...
      return SingleChildScrollView(
        ...
        children: [
          ...
          if (_controller.address.value.isNotEmpty) ...[
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    GestureDetector(
                        ...
                        child: Row(
                          children: [
                            Transform.translate(
                                offset: Offset(
                                    -5, 0), // Adjust the offset as needed
                                child: Radio<String?>(
                    ...
                    if (_controller.selectedAddress.value.sId ==
                        element.sId) ...[
                      const SizedBox(height: 7),
                      ElevatedButton(
                        onPressed: () {
                          _controller.invoiceDownloadCart();
                        },
