...
import 'package:black_locust/view/booking_history/components/booking_history_detail_design2.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class BookingHistoryDesign2 extends StatelessWidget {
  const BookingHistoryDesign2({
    Key? key,
    required controller,
                  ...
                  children: [
                    Obx(() => ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return BookingHistoryDetailDesign2(
