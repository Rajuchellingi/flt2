...
import 'package:black_locust/view/wishlist_login_message/components/wishlist_login_message_block.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class WishlistLoginMessageScreen extends StatelessWidget {
  final _controller = Get.find<WishlistLoginMessageController>();
            ...
            children: [
              Container(
                child: _controller.isLoading.value
                    ...
                    : WishlistLoginMessageBlock(controller: _controller),
              ),
            ],
          ),
