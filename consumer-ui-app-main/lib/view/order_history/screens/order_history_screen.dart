...
import 'package:black_locust/view/order_history/components/order_history_block.dart';
...
class OrderHistoryScreen extends StatelessWidget {
  final dynamic _controller = platform == 'shopify'
      ...
      : Get.find<OrderHistoryV1Controller>();
          ...
          body: Stack(children: [
            Container(
                child: _controller.isLoading.value
                    ...
                    : OrderHistoryBlock(controller: _controller)),
          ]),
