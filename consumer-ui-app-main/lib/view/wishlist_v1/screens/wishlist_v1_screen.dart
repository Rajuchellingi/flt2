...
import 'package:black_locust/view/wishlist_v1/components/wishlist_v1_body.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class WishlistV1Screen extends StatelessWidget {
  final _controller = Get.find<WishlistV1Controller>();
      ...
      return SafeArea(
        ...
        body: SafeArea(
            child: _controller.isLoading.value
                ...
                : WishlistV1Body(wController: _controller)),
      ));
    });
  }
}
