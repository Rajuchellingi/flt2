...
import 'package:black_locust/view/order_confirmed/components/order_scratch_spin_section.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class LoyalityOrderConfirmed extends StatelessWidget {
  LoyalityOrderConfirmed({
    Key? key,
    required controller,
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
                ...
                child: Padding(
                  ...
                  child: Column(children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        "Thanks for order with us. Let's see what you've won...",
                        style: TextStyle(
                          fontSize: 16,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            "Every order gets you closer to exclusive rewards",
                            style: TextStyle(
                              fontSize: 14,
                    ...
                    SizedBox(height: 16),
                    // Order Coins Earned
                    Obx(() => _bController.orderPoints.value > 0
                        ? Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text(
                                  'You earned ${_bController.orderPoints.value} coins!',
                                  style: TextStyle(
                                    fontSize: 15,
          ...
          // ),
          // SizedBox(height: 24),
          OrderScratchSpinSection(controller: _bController),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Get.offAndToNamed('/orderDetail',
                            arguments: {'id': _bController.orderId});
                      },
        ...
        style: TextStyle(
          ...
          color: highlight
              ...
              : completed
                  ...
                  : Colors.grey[600],
          fontWeight:
              highlight || completed ? FontWeight.bold : FontWeight.w600,
        ),
      ),
    ],
  ));
