...
class OrderScratchSpinSection extends StatelessWidget {
  final LoyalityController controller = Get.find<LoyalityController>();
  OrderScratchSpinSection({
    Key? key,
    required controller,
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      var history = loyality.customerScratchcardHistory ?? [];
      var scratchHistory = history
          .where((element) => element.orderId == _bController.orderId)
          .toList();
