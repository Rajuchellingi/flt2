...
import 'package:black_locust/view/enquiry_confirmed/components/enquiry_confirmed_body.dart';
...
class EnquiryConfirmedScreen extends StatelessWidget {
  final _controller = Get.find<EnquiryConfirmationController>();
    ...
    return Obx(() {
      ...
      return SafeArea(
        ...
        appBar: (header != null && header.isNotEmpty)
            ...
            : null,
        body: EnquiryConfirmedBody(controller: _controller),
      ));
    });
  }
}
