...
class CategoryBlockDesign1Submenu extends StatefulWidget {
  ...
  const CategoryBlockDesign1Submenu({
    Key? key,
  ...
  @override
  State<CategoryBlockDesign1Submenu> createState() =>
      _CustomExpansionPanelState();
}

class _CustomExpansionPanelState extends State<CategoryBlockDesign1Submenu>
