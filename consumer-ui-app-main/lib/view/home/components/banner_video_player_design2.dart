...
class BannerVideoPlayerDesgign2 extends StatefulWidget {
  const BannerVideoPlayerDesgign2({
    Key? key,
...
class VideoPlayerBodyState extends State<BannerVideoPlayerDesgign2> {
