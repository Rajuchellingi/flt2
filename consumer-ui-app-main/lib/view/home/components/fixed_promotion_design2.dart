...
class FixedPromotionDesign2 extends StatelessWidget {
  FixedPromotionDesign2({Key? key, required this.design, required controller})
    ...
    return Obx(() => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            //   child: Text(
            //     'View All',
            //     style: TextStyle(color: brightness == Brightness.dark
            //             ? Colors.white
            //             : kPrimaryColor),
            //   ),
            // )),
