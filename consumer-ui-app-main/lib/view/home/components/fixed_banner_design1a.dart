...
class FixedBannerDesign1a extends StatelessWidget {
  const FixedBannerDesign1a({
    Key? key,
...
class _BannerItem extends StatelessWidget {
  ...
  Widget _buildMediaContent() {
    ...
    // print("Building image content for design: ${content['image']}");
    final imageUrl =
    ...
    return Positioned(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          if (design['source']['description']?.isNotEmpty == true)
            SizedBox(
              width: 300,
              child: Text(
