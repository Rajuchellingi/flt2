...
class FixedPromotionDesign9 extends StatelessWidget {
    ...
    return Obx(() => GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: const Color.fromARGB(255, 217, 217, 217), width: 1),
              // boxShadow: [
              //   BoxShadow(
