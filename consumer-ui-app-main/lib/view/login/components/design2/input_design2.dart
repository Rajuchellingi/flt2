// ignore_for_file: must_be_immutable, unused_field, deprecated_member_use, unnecessary_null_comparison
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      TextFormField(
        ...
        onTap: () async {
          if (inputType == InputType.date)
            await showDatePicker(
              ...
              initialDate: textEditingController.text != null &&
                      textEditingController.text.isNotEmpty
                  ? DateFormat("yyyy-MM-dd").parse(textEditingController.text)
                  : DateTime.now(),
        ...
        decoration: InputDecoration(
          ...
          // hintText: hintText,
          fillColor: const Color(0x80C4C0C0),
          filled: true,
          suffix: suffixButton
              ? InkWell(
                  onTap: onSuffixTap,
