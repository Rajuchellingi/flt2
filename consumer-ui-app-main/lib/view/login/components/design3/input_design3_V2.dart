...
class InputDesign3V2 extends StatefulWidget {
  InputDesign3V2(
      {Key? key,
...
class _InputDesign3State extends State<InputDesign3V2> {
  bool isValid = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: InputDecoration(
        ...
        floatingLabelStyle: TextStyle(fontSize: 14, color: Colors.grey),
