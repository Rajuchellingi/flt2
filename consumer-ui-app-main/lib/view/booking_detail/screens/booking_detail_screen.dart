...
import 'package:black_locust/view/booking_detail/components/booking_detail_body.dart';
import 'package:black_locust/view/booking_detail/components/booking_detail_bottom_button.dart';
import 'package:black_locust/view/header/common_header.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class BookingDetailScreen extends StatelessWidget {
  final _controller = Get.find<BookingDetailController>();
      ...
      return SafeArea(
        child: Scaffold(
            ...
            body: _controller.isLoading.value
                ...
                : BookingDetailBody(controller: _controller),
            bottomNavigationBar:
                (_controller.bookingDetail.value.status == 'confirmed' &&
                        _controller.bookingDetail.value.paymentStatus != 'paid')
                    ? BookingDetailBottomButton(controller: _controller)
