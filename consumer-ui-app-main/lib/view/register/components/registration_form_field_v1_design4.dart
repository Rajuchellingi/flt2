...
class RegistrationFormFieldV1Design4 extends StatefulWidget {
  const RegistrationFormFieldV1Design4({
    Key? key,
    required this.block,
  }) : super(key: key);
...
class _registerFormState extends State<RegistrationFormFieldV1Design4> {
