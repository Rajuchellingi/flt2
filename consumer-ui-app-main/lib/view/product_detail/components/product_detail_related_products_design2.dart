...
class ProductDetailRelatedProductsDesign2 extends StatelessWidget {
  const ProductDetailRelatedProductsDesign2(
...
class ItemCard extends StatelessWidget {
  ...
  Container buildRietailProductPrice(product) {
  ...
  Container buildShopifyProductPrice(product) {
    // print("product==>>>> ${product.toJson()}");
    return Container(
      // width: SizeConfig.screenWidth / 2.8,
      width: (SizeConfig.screenWidth / 2.2) - 10,
