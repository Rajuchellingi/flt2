...
import 'package:black_locust/view/enquiry_history/components/enquiry_history_body.dart';
import 'package:black_locust/view/order_history/components/order_list_design2.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class EnquiryHistoryBlock extends StatelessWidget {
  EnquiryHistoryBlock({
    Key? key,
    required controller,
    ...
    return Obx(() {
      ...
      return Column(children: [
        for (var item in blocks)
          if (item['componentId'] == 'enquiry-list-component') ...[
            if (item['instanceId'] == 'design1' &&
                item['visibility']['hide'] == false)
              Expanded(child: EnquiryHistoryBody(controller: _controller))
