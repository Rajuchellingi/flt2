import 'package:black_locust/view/cart/components/cart_quantity_update_design2.dart';
import 'package:flutter/material.dart';

class CartProductItemContentDesign2 extends StatelessWidget {
  const CartProductItemContentDesign2(
      {Key? key,
          ...
          Row(
            children: [
              if (sku.price!.mrp != 0 &&
                ...
                Text(
                  "Rs. " + (sku.price!.mrp * sku.qty).toStringAsFixed(2),
              ...
              Text(
                "Rs. " + (sku.price!.sellingPrice * sku.qty).toStringAsFixed(2),
                style:
