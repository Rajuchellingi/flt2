...
import 'package:black_locust/view/cart/components/cart_apply_coupon_input_design2.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class CartApplyCouponDesign2 extends StatelessWidget {
  final controller;

  const CartApplyCouponDesign2({
    Key? key,
          ...
          child: Column(
              ...
              children: [
                if (_controller.isLoading.value == false) ...[
                  ...
                  CartApplyCoupenInputDesign2(controller: _controller),
                  const SizedBox(height: 10),
