...
import 'package:black_locust/view/cart/components/cart_product_item_content_design3.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';

import '../../../config/configConstant.dart';

class CartProductItemDesign3 extends StatelessWidget {
  const CartProductItemDesign3(
      {Key? key,
      required this.index,
      required controller,
