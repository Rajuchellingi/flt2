...
import 'package:black_locust/view/collection_brand/components/brandCollection_blocks.dart';
...
class BrandCollectionScreen extends StatelessWidget {
  final dynamic _controller = Get.find<CollectionBrandController>();

  // : Get.find<CollectionV1Controller>();
  final themeController = Get.find<ThemeController>();
  @override
  Widget build(BuildContext context) {
    // print("hloooo call my name of Brand Collection Screen");
    return Obx(() {
        ...
        child: Scaffold(
          ...
          body: Obx(
            () => _controller.isLoading.value
                ...
                : BrandCollectionBlocks(controller: _controller),
          ),
