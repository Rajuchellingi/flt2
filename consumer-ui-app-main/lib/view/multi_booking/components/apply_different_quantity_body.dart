...
import 'package:black_locust/view/multi_booking/components/apply_different_quantity_design1.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ApplyDifferentQuantityBody extends StatelessWidget {
  ApplyDifferentQuantityBody({
    Key? key,
    required controller,
    ...
    return Obx(() {
      if (_controller.isLoading.value) {
        ...
        if (template['instanceId'] == 'design1') {
          return ApplyDifferentQuantityDesign1(controller: _controller);
        } else {
