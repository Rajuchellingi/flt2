...
import 'package:black_locust/view/multi_booking/components/apply_same_quantity_body.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ApplySameQuantityScreen extends StatelessWidget {
    ...
    return Obx(() {
      ...
      return SafeArea(
        ...
        appBar: (header != null && header.isNotEmpty)
            ...
            : null,
        body: ApplySameQuantityBody(controller: _controller),
      ));
    });
  }
}
