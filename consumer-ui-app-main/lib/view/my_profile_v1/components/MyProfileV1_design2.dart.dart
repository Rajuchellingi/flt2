// ignore_for_file: invalid_use_of_protected_member, unused_element, unused_local_variable, unnecessary_null_comparison
...
class MyProfileV1BodyV1Design2 extends StatelessWidget {
  MyProfileV1BodyV1Design2({
    Key? key,
    required controller,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_controller.emailController.text != null)
                          Text(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            /// Replace ElevatedButton with Container-based design
            GestureDetector(
              onTap: () {
                if (_controller.activeSection.value == type) {
              ...
              child: Obx(
                () => Container(
                  ...
                  child: Text(
                    _controller.activeSection.value == type ? 'Save' : 'Change',
    ...
    return Column(
      ...
      children: [
        ...
        CustomTextFieldV1(
          ...
          errorMsg: emailField.required == true
              ? 'Enter ${emailField.label ?? 'Email'}'
              : null,
    ...
    return Column(
      ...
      children: [
        ...
        CustomTextFieldV1(
          ...
          errorMsg: mobileField.required == true
              ? 'Enter ${mobileField.label ?? 'Mobile Number'}'
              : null,
