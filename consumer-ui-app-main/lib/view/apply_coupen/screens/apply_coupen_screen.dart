...
import 'package:black_locust/view/apply_coupen/components/apply_coupen_body.dart';
import 'package:black_locust/view/header/common_header.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ApplyCoupenScreen extends StatelessWidget {
  final _controller = Get.find<ApplyCoupenController>();
      ...
      return SafeArea(
        child: Scaffold(
            ...
            body: _controller.isLoading.value
                ...
                : ApplyCoupenBody(controller: _controller)),
      );
    });
  }
}
