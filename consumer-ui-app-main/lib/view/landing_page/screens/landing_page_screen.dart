...
class LandingPageScreen extends StatelessWidget {
  final _controller = Get.find<LandingPageController>();
    ...
    return Obx(() {
      ...
      return SafeArea(
        ...
        child: Scaffold(
          ...
          appBar: _buildAppBar(_controller, header),
          body: Stack(
            children: [
  ...
  PreferredSizeWidget? _buildAppBar(
      LandingPageController controller, dynamic header) {
  ...
  Widget _buildMainContent(
      LandingPageController controller, Brightness brightness) {
    return Container(
  ...
  Widget _buildRewardButton(LandingPageController controller) {
    return Positioned(
      bottom: 5,
      left: 10,
  ...
  Widget? _buildFooter(String? footerDesign, LandingPageController controller) {
